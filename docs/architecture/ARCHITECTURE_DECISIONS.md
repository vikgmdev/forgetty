...
> Decisions here override anything in , , or older docs if they conflict.
...
| "Two GTK windows see each other's changes via subscribe_layout" |  T-065 AC | Dropped — each daemon is single-tenant (AD-006) |
